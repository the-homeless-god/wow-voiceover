...
OUTPUT_FOLDER = 'translator/assets/wow-classic-ru/AI_VoiceOverData_Vanilla/generated'
...
REPLACE_DICT = {'$b': '\n', '$B': '\n', '$n': 'герой', '$N': 'Герой',
                '$C': 'Герой', '$c': 'герой', '$R': 'Герой', '$r': 'герой'}
...
class TTSProcessor:
    ...
    def preprocess_dataframe(self, df):
        ...
        df['cleanedText'] = df['cleanedText'].str.replace(r'\$g([^:]+):([^;]+);', r'\1', regex=True)
    ...
    def tts_row(self, row):
        ...
        self.tts(tts_text, input_file_name, output_file_name, subfolder, 'ru')
    ...
    def tts_dataframe(self, df):
        ...
        self.process_rows_in_parallel(df, self.process_row, max_workers=STATIC_MAX_WORKERS)
